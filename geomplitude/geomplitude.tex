...
\begin{align*}
  ...
  \mathcal{I}_{a,b,c,d}^{\text{fin}}&= \mathcal{I}_{a,b,c,d}=\operatorname{Li}_{2}(z)-\operatorname{Li}_{2}(\bar{z})+\frac{1}{2}\log(z\bar{z})\log{\frac{1-z}{1-\bar{z}}}
\end{align*}
...
\begin{frame}{Algebraic Words}
 ...
 For non-degenerate $\mathcal{X}_{a,b,c,d}^{\ast}$'s as the third entry:
  \begin{align*}
      &\quad \mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{c-1}\otimes x_{a,b,c,d}^{c-1} \,[a{-}1\,a\,b{-1}\,b\,c-1] \nonumber \\
      &-\mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{c}\otimes x_{a,b,c,d}^{c} \,[a{-}1\,a\,b{-1}\,b\,c] \nonumber \\
      &+ \mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{b-1}\otimes x_{a,b,c,d}^{b-1} \,[a{-}1\,a\,b{-1}\,c-1\,c] \nonumber \\
      &-\mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{b}\otimes x_{a,b,c,d}^{c} \,[a{-}1\,a\,b\,c{-1}\,c] \nonumber \\
      &+\mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{a-1}\otimes x_{a,b,c,d}^{a-1} \,[a{-}1\,b{-1}\,b\,c-1\,c] \nonumber \\
      &-\mathcal{S}(\mathcal{I}_{a,b,c,d})\otimes \mathcal{X}_{a,b,c,d}^{a}\otimes x_{a,b,c,d}^{a} \,[a\,b{-1}\,b\,c{-}1\,c]  \:,\label{Xalgebraicword}
  \end{align*}
